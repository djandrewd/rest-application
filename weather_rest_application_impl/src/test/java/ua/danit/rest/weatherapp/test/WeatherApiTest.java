...
public class WeatherApiTest {
  ...
  public static void initApplication() throws Exception {
    ...
    ReflectionServiceParser parser = new RealReflectionServiceParser();
    application = new RestApplicationDelegate(builder().withPort(SERVICE_PORT)
                                                       .withMatchingUrls(SERVICE_URLS)
